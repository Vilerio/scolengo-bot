...
exports.TokenSet = exports.Skolengo = void 0;
...
const SkolengoError_1 = require("./models/Common/SkolengoError");
...
class Skolengo {
     ...
     */
    constructor(oidClient, school, tokenSet, onTokenRefresh = (tokenSet) => {
    }, httpClient) {
     ...
     * @async
     */
    static async getAppCurrentConfig() {
     ...
     * @async
     */
    static async searchSchool(filter, limit = 10, offset = 0) {
        return (0, jsonapi_fractal_1.deserialize)((await axios_1.default.request({
            baseURL: BASE_URL,
            url: '/schools',
            method: 'get',
    ...
    static async getOIDClient(school, redirectUri = 'skoapp-prod://sign-in-callback') {
        const skolengoIssuer = await openid_client_1.Issuer.discover(school.emsOIDCWellKnownUrl);
     ...
     * ```
     */
    static async fromConfigObject(config, onTokenRefresh = (tokenSet) => {
    }, httpClient) {
        const oidClient = await Skolengo.getOIDClient(config.school);
        const tokenSet = new openid_client_1.TokenSet(config.tokenSet);
     ...
     * @async
     */
    async getUserInfo(userId, params) {
     ...
     * @async
     */
    async getSchoolInfo(schoolInfoId = this.school.id, params) {
        return (0, jsonapi_fractal_1.deserialize)((await this.request({
     ...
     * @async
     */
    async getEvaluationSettings(studentId = this.tokenSet.claims().sub, limit = 20, offset = 0, params) {
        return (0, jsonapi_fractal_1.deserialize)((await this.request({
     ...
     * @async
     */
    async getEvaluation(studentId = this.tokenSet.claims().sub, periodId, limit = 20, offset = 0, params) {
        return (0, jsonapi_fractal_1.deserialize)((await this.request({
     ...
     * @async
     */
    async getEvaluationDetail(studentId = this.tokenSet.claims().sub, evaluationId, params) {
        return (0, jsonapi_fractal_1.deserialize)((await this.request({
     ...
     * ```
     */
    async getPeriodicReportsFiles(studentId = this.tokenSet.claims().sub, limit = 20, offset = 0, params) {
        return (0, jsonapi_fractal_1.deserialize)((await this.request({
     ...
     * ```
     */
    async getAgenda(studentId = this.tokenSet.claims().sub, startDate, endDate, limit = 20, offset = 0, params) {
     ...
     * @async
     */
    async getLesson(studentId = this.tokenSet.claims().sub, lessonId, params) {
        return (0, jsonapi_fractal_1.deserialize)((await this.request({
     ...
     * @async
     */
    async getHomeworkAssignments(studentId = this.tokenSet.claims().sub, startDate, endDate, limit = 20, offset = 0, params) {
        return (0, jsonapi_fractal_1.deserialize)((await this.request({
     ...
     * @async
     */
    async getHomeworkAssignment(studentId = this.tokenSet.claims().sub, homeworkId, params) {
        return (0, jsonapi_fractal_1.deserialize)((await this.request({
     ...
     * @async
     */
    async patchHomeworkAssignment(studentId = this.tokenSet.claims().sub, homeworkId, attributes, params) {
        return (0, jsonapi_fractal_1.deserialize)((await this.request({
            method: 'patch',
            url: `/homework-assignments/${homeworkId}`,
            responseType: 'json',
     ...
     * @async
     */
    async getUsersMailSettings(userId, params) {
        return (0, jsonapi_fractal_1.deserialize)((await this.request({
     ...
     * @async
     */
    async getCommunicationsFolder(folderId, limit = 10, offset = 0, params) {
        return (0, jsonapi_fractal_1.deserialize)((await this.request({
            url: '/communications',
            responseType: 'json',
            params: {
     ...
     * @async
     */
    async getCommunicationParticipations(communicationId, params) {
        return (0, jsonapi_fractal_1.deserialize)((await this.request({
     ...
     * @async
     */
    async getCommunicationParticipants(communicationId, fromGroup = true, params) {
        return (0, jsonapi_fractal_1.deserialize)((await this.request({
     ...
     * ```
     */
    async getAbsenceFiles(studentId = this.tokenSet.claims().sub, limit = 20, offset = 0, params) {
     ...
     * @async
     */
    async getAbsenceFile(folderId, params) {
        return (0, jsonapi_fractal_1.deserialize)((await this.request({
    ...
    async request(config) {
        ...
        try {
            ...
            if (response.data.errors instanceof Array && response.data.errors.length > 0) {
                throw new SkolengoError_1.SkolengoError(response.data.errors[0]);
            }
